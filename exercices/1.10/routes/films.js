...
// Read all the films, TAKES CARE OF THE DURATION 
  ...
  router.get('/', (req, res) => {
    const minimumFilmDuration = req?.query?.['minimum-duration'] ? Number(req.query['minimum-duration']): undefined;
...
router.get('/:id', (req, res) => {
  ...
  const indexOfFilmFound = FILMS.findIndex((FILM) => FILM.id === parseFloat(req.params.id));
...
router.delete('/:id', (req, res) => {
    ...
    const foundIndex = FILMS.findIndex(film => film.id === parseFloat(req.params.id));
